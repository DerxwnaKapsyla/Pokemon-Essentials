...
NTS_TIMEPROPORTION=24 # Derx: This will equate to 1rlh (Real Life Hour) being 1igd (In-Game Day). You've done this math several times now. Relax.
...
# Initial values
NTN_INITIALYEAR=2020 # Can ONLY holds around range 1970-2038
NTN_INITIALMONTH=8
NTN_INITIALDAY=13
NTN_INITIALHOUR=12
NTN_INITIALMINUTE=0
