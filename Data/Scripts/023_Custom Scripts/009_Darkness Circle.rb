#--------------------------------------------------------------------------------
# This code allows you to have a modifyable Flash Circle around the player
# Code was provided during the "Blinded by the Fright" Game Jam on PokeCommunity
#--------------------------------------------------------------------------------
DEFAULTDARKCIRCLERAD = 96
$DarknessSprite = nil
