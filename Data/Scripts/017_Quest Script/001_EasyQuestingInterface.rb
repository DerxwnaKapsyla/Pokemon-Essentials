...
#   Quest.new(0, "Find a Super Rod!", "Find a Super Rod somewhere in the field. This item does not have to be handed over.", "Quest Master", "trchar039", "Queesting Town", :SUPERLIGHTBLUE, Time.now, true),
   Quest.new(0, "Journey's Start", "No Description.", "Main Scenario Quest", "Register for the Yitria League", "", "Pharos City", :SUPERLIGHTBLUE, Time.now, true),
   Quest.new(1, "First Steps", "It seems like my sibling is calling me from downstairs, I should go see what they want.", "Main Scenario Quest", "Head downstairs.", "", "Pharos City", :SUPERLIGHTBLUE, Time.now, false),
   Quest.new(2, "My First Pokémon", "I need to head over to Professor Hawthorn's lab to obtain my starter Pokémon! His lab is in the northern part of Pharos City.", "Main Scenario Quest", "Head to the lab.", "", "Pharos City", :SUPERLIGHTBLUE, Time.now, false),
   Quest.new(3, "Badgequest 20xx - 1", "The first gym is in Veiskille City, I should make my way over there to challenge the gym!", "Main Scenario Quest", "Beat the Veiskille Gym Leader.", "", "Pharos City", :SUPERLIGHTBLUE, Time.now, false),
   Quest.new(4, "A Cherished Gift", "My dad said that he'd have something for me after I get my first Pokémon. I should come back then.", "Sidequest", "Check in with Dad later.", "", "Pharos City", :LIGHTGREEN, Time.now, false),
   Quest.new(5, "Treasured Memento", "A child in Veiskille City told me that one of their precious treasures was stolen. They said they saw the thief on Route 3, I should check there.", "Sidequest", "Find the thief.", "", "Veiskille City", :LIGHTGREEN, Time.now, false),
   Quest.new(6, "Grains of Sand", "Someone in Pharos City said that they were opening up something called the 'Sandbox Zone'. They asked me to help find more people before they can open up, though. I should check around Veiskille City.", "Sidequest", "Find potential recruits.", "", "Pharos City", :LIGHTGREEN, Time.now, false),
   Quest.new(7, "Enigmatic Situation", "The Yozora Gym Leader asked me to help deal with a disturbance at the Observatory. I wonder what's going on over there?.", "Main Scenario Quest", "Deal with the disturbance at Yozora Observatory.", "", "Yozora Island", :SUPERLIGHTBLUE, Time.now, false),
]
...
#      pbDrawOutlineText(@text2,188,22,512,384,quest.type,Color.new(255,172,115),Color.new(0,0,0))
      ...
      pbDrawOutlineText(@text2,188,22,512,384,quest.obj,Color.new(255,172,115),Color.new(0,0,0))      
