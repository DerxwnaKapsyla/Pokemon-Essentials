...
#	* Added Fretful to AI checks for free turns
#	* Added Touhoumon Flying to AI checks for Perish Song switchouts
#==============================================================================#
class Battle::AI
  #=============================================================================
    ...
    if @battle.pbSideSize(battler.index + 1) == 1 &&
      ...
      if (opp.effects[PBEffects::HyperBeam] > 0 ||
         ((opp.hasActiveAbility?(:TRUANT) ||
           opp.hasActiveAbility?(:FRETFUL)) && opp.effects[PBEffects::Truant])) && pbAIRandom(100) < 80
        shouldSwitch = false
      end
    end
        ...
        if battler.effects[PBEffects::PerishSong] != 1
          ...
          if spikes > 0
            ...
            next if pkmn.hp <= pkmn.totalhp / spikesDmg &&
                    !(pkmn.hasType?(:FLYING) ||
                      pkmn.hasType?(:FLYING18)) && !pkmn.hasActiveAbility?(:LEVITATE)
          end
        end
