#==============================================================================
# "Maruno's Experimental Map Renderer" plugin
#==============================================================================

Essentials::ERROR_TEXT += "[Maruno's Experimental Map Renderer 1.0.2]\r\n"
  ...
  class TilesetBitmaps
    ...
    def set_src_rect(tile, tile_id)
      ...
      if @bitmap_wraps[tile.filename]
        ...
        col = (tile_id - TILESET_START_ID) * SOURCE_TILE_HEIGHT / (height * TILESET_TILES_PER_ROW)
