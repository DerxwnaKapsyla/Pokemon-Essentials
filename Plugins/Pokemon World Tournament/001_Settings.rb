...
GameData::PWTTournament.register({
  ...
  :trainers => [
				...
				#[:REP_M,"Slate","AI Lose Text","AI Victory Text",500]
				#[:REP_F,"Lily","AI Lose Text","AI Victory Text",500],
				#[:REP_M,"Sergio","AI Lose Text","AI Victory Text",500],
				#[:REP_F,"Hana","AI Lose Text","AI Victory Text",500],
				#[:REP_M,"Solomon","AI Lose Text","AI Victory Text",500],
				#[:REP_F,"Jolyne","AI Lose Text","AI Victory Text",500],
				#[:REP_M,"Char","AI Lose Text","AI Victory Text",500],
				#[:REP_Y,"Yellow","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Falkner]","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Bugsy]","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Whitney]","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Morty]","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Jasmine]","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Chuck]","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Glacia]","AI Lose Text","AI Victory Text",500],
				#[:REP_,"[Clair]","AI Lose Text","AI Victory Text",500],
               ],
