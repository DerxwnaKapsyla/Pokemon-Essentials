...
class ScreenChooseFileSave
  ...
  def pbUpdate
    oldi = @sprites["cmdwindow"]
    pbUpdateSpriteHash(@sprites)
    newi = @sprites["cmdwindow"]
    if oldi != newi
...
#-------------------------------------------------------------------------------
  ...
  def drawInfor(type,font=nil)
    ...
    textpos<<[_INTL("Losses:"), 32 + x, 150 + y, 0, TEXTCOLOR, TEXTSHADOWCOLOR]
    textpos<<[$stats.trainer_battles_lost.to_s, 206 + x, 150 + y, 1, TEXTCOLOR, TEXTSHADOWCOLOR]
    textpos<<[_INTL("Scenario:"), 32 + x, 182 + y, 0, TEXTCOLOR, TEXTSHADOWCOLOR]
	#textpos<<["[Placeholder]", 152 + x, 182 + y, 0, TEXTCOLOR, TEXTSHADOWCOLOR]
    textpos<<[trainer.scenario_name, 152 + x, 182 + y, 0, TEXTCOLOR, TEXTSHADOWCOLOR]
    textpos<<[_INTL("Time:"), 32 + x, 118 + y, 0, TEXTCOLOR, TEXTSHADOWCOLOR]
    hour = totalsec / 60 / 60
    min  = totalsec / 60 % 60
    if hour>0
      textpos<<[_INTL("{1}h {2}m",hour,min), 206 + x, 118 + y, 1, TEXTCOLOR, TEXTSHADOWCOLOR]
    else
      textpos<<[_INTL("{1}m",min), 206 + x, 1818 + y, 1, TEXTCOLOR, TEXTSHADOWCOLOR]
    end
    if trainer.male?
