...
class TypeMatch_Scene
  ...
  def pbStartScene
    ...
    @typebitmapsmall = AnimatedBitmap.new(_INTL("Graphics/UI/pokedex/icon_types"))
    2.times do |i|
    ...
    @sprites["right_arrow"] = AnimatedSprite.new("Graphics/UI/right_arrow",8,40,28,2,@viewport)
    @sprites["right_arrow"].x = Graphics.width - @sprites["right_arrow"].bitmap.width
    @sprites["right_arrow"].y = Graphics.height/2 - @sprites["right_arrow"].bitmap.height/16
    @sprites["right_arrow"].visible = false
    @sprites["right_arrow"].play
    @sprites["left_arrow"] = AnimatedSprite.new("Graphics/UI/left_arrow",8,40,28,2,@viewport)
    @sprites["left_arrow"].x = 0
    @sprites["left_arrow"].y = Graphics.height/2 - @sprites["right_arrow"].bitmap.height/16
  ...
  def drawTypes(type)
    @sprites["right_arrow"].visible = (@index < @types.length-1) ? true : false
    @sprites["left_arrow"].visible = (@index > 0) ? true : false
    @overlay_type.clear
