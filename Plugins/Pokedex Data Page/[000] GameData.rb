...
#-------------------------------------------------------------------------------
# Placeholder Gen 9 Evolution methods for v21.1 compatibility.
#-------------------------------------------------------------------------------
GameData::Evolution.register({
  :id            => :LevelWalk,
  :parameter     => Integer,
  :description   => _INTL("after walking {1} steps with it as party leader"),
  :any_level_up  => true,
...
GameData::Evolution.register({
  :id            => :LevelWithPartner,
  :parameter     => Integer,
  :description   => _INTL("while you are partnered with another trainer"),
  :level_up_proc => proc { |pkmn, parameter|
...
GameData::Evolution.register({
  ...
  :parameter     => :Move,
  :description   => _INTL("after it has used the move {1} 20 times"),
  :any_level_up  => true,
  :level_up_proc => proc { |pkmn, parameter|
...
GameData::Evolution.register({
  ...
  :parameter     => Integer,
  :description   => _INTL("after losing at least {1} HP to recoil"),
  :any_level_up  => true,
  :level_up_proc => proc { |pkmn, parameter|
...
GameData::Evolution.register({
  ...
  :parameter     => :Item,
  :description   => _INTL("after it beats 3 of its own kind that held {1}"),
  :any_level_up  => true,
  :level_up_proc => proc { |pkmn, parameter|
...
GameData::Evolution.register({
  :id            => :CollectItems,
  :parameter     => :Item,
  :description   => _INTL("with atleast 999x {2} in the bag"),
  :any_level_up  => true,
  :level_up_proc => proc { |pkmn, parameter|
