module QuestModule
  ...
  Quest13 = {
    ...
    :QuestDescription => "While Renko and I were discussing things, a urgent broadcast played on the radio, reporting that the Power Plant had been taken over by a group of thugs. Renko mentioned that the Power Plant was one of the places she wanted to check out, and immediately bolted out of the room! Time to see what's going on over there!",
    :RewardString => "nil"
  }
  ...
  Quest14 = {
    ...
    :Stage1 => "Head to the Kanto Power Plant and assess the situation.",
    :Location1 => "Vermilion City",
    :QuestDescription => "While Mary and I were discussing things, a urgent broadcast played on the radio, reporting that the Power Plant had been taken over by a group of thugs. Mary mentioned that the Power Plant was one of the places she wanted to check out, and immediately bolted out of the room! Time to see what's going on over there!",
    :RewardString => "nil"
  }
...
#----- Side Quests -----#
  ...
  Quest103 = {
	...
	:Stage2 => "Return to the Delivery Man inside Cerulean Pokémon Center.",
