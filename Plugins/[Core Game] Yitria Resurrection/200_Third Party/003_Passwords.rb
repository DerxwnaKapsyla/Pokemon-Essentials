...
def pbPasswordCheck(helptext = "Input Password", minlength = 0, maxlength = 12, casesensitive = false)
  ...
  # --- Pokemon and Puppet Distributions ---
	"truewaifu",			# Spawns a Shadow Lugia with a special movepool at the Shrine of the Mystics
	"hwctfctp",				# Spawns a Primal Dialga with a special movepool at the Shrine of the Mystics
	"notthebadone",			# Spawns a MissingNo atop Mt. Fuguai
	
  # --- Item Distributions ---
	"cherishem",			# 50 Cherish Balls  
	"shinyem",				# 50 Glitter Balls
	"howdreamy",			# 20 Dream Balls
  ...
  # --- Difficulty Altering ---
	...
	"whohurtyou",			# All Wild/Traded/Gifted Pokemon have 0 IVs in all stats
	...
	"scuffedaf",			# All trainers have 31^6 IVs and 252^6 EVs, restricts items in battle, removes EXP, EV, and Money gain, and makes it so all Player-obtained Pokemon have 0 IVs
	
  # --- Misc Functionality ---
	"purplenum",			# Unlocks Pandora's Box.
	"4thehomies",			# Unlocks the Storeroom in Kortalan Interactive Museum.
	"freincarnate",			# Removes the cost on Reincarnation
	
  # --- Outfits, if I keep them ---	
	"hifuutime",			# Unlocks the Renko and Maribel costumes
	"oldschool",			# Unlocks the Red and Blue costumes
	"likenyaa",				# Unlocks the Rin Kaenbyou costume
