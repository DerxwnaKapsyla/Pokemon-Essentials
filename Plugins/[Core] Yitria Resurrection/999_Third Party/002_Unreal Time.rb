...
module UnrealTime
  ...
  PROPORTION=24 # Derx: This will equate to 1rlh (Real Life Hour) being 1igd (In-Game Day). You've done this math several times now. Relax.
  ...
  def self.initial_date
    return Time.local(2075,6,18, 12,0)
  end
