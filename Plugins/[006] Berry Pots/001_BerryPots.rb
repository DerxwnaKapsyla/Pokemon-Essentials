...
# By Caruban
#
# Updated to v19 by DerxwnaKapsyla
#-------------------------------------------------------------------------------
...
#    :SPRINKLOTAD  # Sprinklotad # Derx: This item doesn't exist in Asteria, so to prevent it from throwing an error it's been commented out
]
