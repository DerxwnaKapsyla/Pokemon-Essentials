...
#==============================================================================#  
  BASE_ABILITY_RATINGS = {
    10 => [:DELTASTREAM, :DESOLATELAND, :HUGEPOWER, :MOODY, :PARENTALBOND,
		   ...
		   :FANTASYNATURE, :FANTASYNATURE_ALT, :UNZAN, :SPECTRALGUARD,
		   :SPECTRALSTRIKE, :ULTIMATEDREAM_1, :ULTIMATEDREAM_2, :ULTIMATEDREAM_3],
    ...
    8  => [:ADAPTABILITY, :AERILATE, :CONTRARY, :DISGUISE, :DRAGONSMAW,
		   ...
		   :SERAPHSWINGS, :ULTIMATEDREAM_1, :ULTIMATEDREAM_2, :ULTIMATEDREAM_3],
    ...
    6  => [:BATTLEBOND, :CHLOROPHYLL, :COMATOSE, :DARKAURA, :DRYSKIN,
		   ...
		   :DOLLWALL, :LUCIDDREAMING, :FLOWOFTIME, :SPECTRALTWIN, :SPECTRALTOUCH],
    ...
    2  => [:BATTLEARMOR, :COLORCHANGE, :CUTECHARM, :DAMP, :GRASSPELT,
		   ...
		   :MYSTERIOUS, :GATEKEEPER, :DIVA, :GUARDARMOR, :SPECTRALENCHANT],
...
Battle::AI::Handlers::AbilityRanking.copy(:CUTECHARM, :SPECTRALENCHANT)
