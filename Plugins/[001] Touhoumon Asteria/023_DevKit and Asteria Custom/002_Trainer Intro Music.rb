...
#    :CUEBALL 			=> 'P-001. Demystify Feast',
    ...
    :GAMBLER 			=> 'P-022. Trainers\' Eyes Meet (Suspicious Figure 1)',
    :GENTLEMAN 			=> 'P-017. Trainers\' Eyes Meet (Gentleman)',
    :HIKER 				=> 'P-006. Trainers\' Eyes Meet (Hiker)',
    :JUGGLER 			=> 'P-010. Trainers\' Eyes Meet (Cooltrainer)',
...
#    :PROFESSOR 		=> 'P-001. Demystify Feast',
    :ROCKER		 		=> 'P-018. Trainers\' Eyes Meet (Black Belt)',
...
#    :SAILOR 			=> 'P-001. Demystify Feast',
    ...
    :POKEMONRANGER_M 	=> 'P-010. Trainers\' Eyes Meet (Cooltrainer)',
    :POKEMONRANGER_F 	=> 'P-010. Trainers\' Eyes Meet (Cooltrainer)',
    :PSYCHIC_M 			=> 'P-008. Trainers\' Eyes Meet (Psychic)',
    :PSYCHIC_F 			=> 'P-008. Trainers\' Eyes Meet (Psychic)',
    :SWIMMER_M 			=> 'P-005. A Trainer Appears (Boy Version)',
    :SWIMMER_F 			=> 'P-011. A Trainer Appears (Girl Version).ogg',
    :SWIMMER2_M 		=> 'P-005. A Trainer Appears (Boy Version)',
...
#    :TUBER2_F 			=> 'P-001. Demystify Feast',
    :COOLCOUPLE 		=> 'P-010. Trainers\' Eyes Meet (Cooltrainer)',
    :CRUSHKIN 			=> 'P-018. Trainers\' Eyes Meet (Black Belt)',
