class PokemonLoadPanel < SpriteWrapper
  ...
  TEXTCOLOR             = Color.new(232,232,232)# Derx: Changes made to default
  TEXTSHADOWCOLOR       = Color.new(136,136,136)# Derx: colors.
  MALETEXTCOLOR         = Color.new(232,232,232)#(56,160,248)
  MALETEXTSHADOWCOLOR   = Color.new(136,136,136)#(56,104,168)
